          ...
          module.exports = function (_ref) {
            ...
            if (isVocal(part)) {
              ...
              if (isVocal(nextPart)) {
                ...
                if (isStrongVocal(part) || isStrongVocal(nextPart)) {
                  if (
                    isAccentedWeakVocal(part) ||
                    isAccentedWeakVocal(nextPart)
                  ) {
                    addSyllable(syllable);
                    return;
                  }
            ...
            function isStrongVocal(str) {
              if (!str) return false;
              return (
                str.match(vocals.strong) || str.match(vocals.accentedStrong)
              );
            }
            ...
            _createClass(SyllablesProcessor, [
              {
                ...
                value: function run(params) {
                  if (!languages[this.lang])
                    throw new Error(
                      "Language " + this.lang + " not available yet."
                    );
      ...
      4: [
        function (require, module, exports) {
          ...
          module.exports = function (lang) {
            ...
            if (!langMap[lang])
              throw new Error("Language " + lang + " not available yet.");
            return langMap[lang];
          };
        },
        {},
            ...
            _createClass(Word, [
              ...
              },
              {
                ...
                value: function get(index) {
                  if (index > this.partsCount || index < 0)
